...
export default function Home() {
  ...
  return (
    <>
      ...
      <main>
        {/* Hero Section */}
        <section ref={heroRef} className="relative h-screen flex items-center justify-center bg-gradient-to-r from-black via-gray-900 to-black text-white overflow-hidden">
          <motion.div 
            style={{ y }}
          ...
          >
            ...
            <motion.p 
              className={`${playfair.className} text-lg md:text-xl text-gray-300 mb-12 max-w-2xl mx-auto leading-relaxed tracking-wide`}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
